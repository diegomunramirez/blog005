        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center">
                    <a href="https://www.genotipo.com/" class="text-2xl font-bold text-primary-600 hover:text-primary-700 transition-colors">
                        <img class="h-10 w-10 sm:w-auto rounded-lg" lazy="loading"
                         src="https://th.bing.com/th/id/OLC.Dqu7SrJA5I3bLg480x360?&rs=1&pid=ImgDetMain&o=7&rm=3" alt="Logo Genotipo">
                        MiniBlog
                    </a>
                </div>
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="<?= base_url('/admin/dashboard') ?>" class="text-white hover:bg-blue-500 font-medium transition-colors bg-blue-700 px-3 py-1 rounded-lg">
                        Administrar posts
                    </a>
                </nav>
            ...
            <div class="md:hidden hidden pb-4" id="mobile-menu">
                <nav class="flex flex-col space-y-2">
                    ...
                    <a href="#" class="text-gray-700 hover:text-primary-600 font-medium py-2 transition-colors">
                        Acerca de
                    </a>
                    <a href="#" class="text-gray-700 hover:text-primary-600 font-medium py-2 transition-colors">
                        Contacto
    ...
    <footer class="bg-gray-800 text-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Archivo</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
                <p>&copy; <?= date('Y') ?> Genotipo. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
